...
export function Adventures() {
  // Show only featured/popular adventures on homepage (limit to 4)
  const popularAdventures = blogPosts.filter(post => post.isFeatured).slice(0, 4);
  const featuredPost = popularAdventures[0];
  const otherPosts = popularAdventures.slice(1, 4);
